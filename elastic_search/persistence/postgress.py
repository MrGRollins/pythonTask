...
from elastic_search.core.elastic import ELASTIC_CLIENT
from elastic_search.db.models.shop import ShopModel
from elastic_search.domain.shop import Shop
...
class PostgresShopPersistence(ShopPersistence):
    ...
    def save(self, name: str, description: str,
        ...
        return Shop(id=shop_model.id, name=shop_model.name, description=shop_model.description,
                    count_left=shop_model.count_left, create_time=shop_model.create_time,
    ...
    def get_product_by_name(self, product_name: str) -> Shop:
        ...
        if shop_model["hits"]["max_score"]:
            return Shop(id=shop_model["hits"]["hits"][0]["_source"]["id"],
            ...
            return Shop(id=0, name=0, description=0,
                        count_left=0, create_time=0, update_time=0)